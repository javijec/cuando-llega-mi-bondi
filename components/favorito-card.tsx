    ...
    >
      ...
      {process.env.NODE_ENV === 'development' && _debug && (
        <div className="absolute top-2 right-2 text-[8px] bg-black/90 text-white px-2 py-1 rounded font-mono z-10">
          <div className="flex flex-col gap-0.5">
            ...
            <div>
              V:{isVisible ? '👁️' : '💤'} | 
              D:{isVisibleDebounced ? '✓' : '✗'} | 
              A:{isActivated ? '🚀' : '⏳'}
            </div>
            {/* Estado de la query */}
            <div className="border-t border-white/20 pt-0.5 mt-0.5">
              <span className={_debug.queryEnabled ? 'text-green-400' : 'text-red-400'}>
      ...
      <div className="border-t border-border pt-4">
        ...
        {!hasBeenActivated ? (
          ...
          // Estado 3: Error
          <div className="py-2">
            <p className="text-destructive text-xs mb-1">Error al cargar arribos</p>
            <button
          ...
          <div className="py-2">
            <p className="text-muted-foreground text-xs">Sin unidades en camino</p>
